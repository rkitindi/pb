	...
	<div id="form_wrapper">
			...
			<form action="insert.php" method="post">
				<div id="form_section2">				
					...
					<input type="text" id="pname" name="product_name" required placeholder="Type Product Name"><br>
					<label for="weight">Net Weight</label><br>
					<input type="number" id="weight" name="net_weight" required placeholder="Specify Net Weight (Kg)"><br>
					...
					<input type="text" id="pdesc" name="prod_desc" required placeholder="Type Product Description"><br>
				</div>
				<div id="form_bottons">
