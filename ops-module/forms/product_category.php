...
<body>
	<div id="form_wrapper">
			<div id="form_section1"> FILL THIS FORM BELOW TO REGISTER PRODUCT TYPES</div>
			<form action="insert.php" method="post">
				<div id="form_section2">				
					<label for="p_name">Product Name:</label><br>
					<input type="text" id="p_name" name="prod_name" required placeholder="Type Product Name"><br>
					<label for="p_code">Product Code:</label><br>
					<input type="text" id="p_code" name="product_code" required placeholder="Type Product Code"><br>
