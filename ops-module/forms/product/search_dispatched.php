...
<body>
	<div id="form_wrapper">
			<div id="form_section1"> FILL THIS FORM BELOW TO SEARCH DISPATCH</div>
			<form action="insert.php" method="post">
				<div id="form_section2">				
					<label for="pname">Dispatch Date:</label><br>
					...
					<label for="pcode">POS:</label><br>
					<input type="text" id="pos" name="pos" required placeholder="Select POS"><br>
				</div>
				<div id="form_bottons">
		...
		<script type="text/javascript"> 
            $("#search").click(function(){
                $("#mod_display").load("forms/product/update_dispatched.php"); 
            });
		</script>
</body>
</html>