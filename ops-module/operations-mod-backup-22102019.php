...
<html>
        ...
        <div id="content_area">
			 ...
			 ACCOUNTING MENU
				<div class="list-type1">
					<ol>
						<li><a id="supp-ops" href="#">Suppliers</a></li>
						<li><a id="truck-ops" href="#">Trucks</a></li>
						<li><a id="case-ops" href="#">Cases</a></li>
					    <li><a id="batch-ops" href="#">Batches</a></li>
						<li><a id="prod-ops" href="#">Products</a></li>
						<li><a id="pos-ops" href="#">POS</a></li>
						<li><a id="cust-ops" href="#">Customers</a></li>
					</ol>
				</div> 
			 </div>
	...
	<script type="text/javascript"> 
			...
			$("#prod-ops").click(function(){
                $("#mod_display").load("forms/product/product_operations.html"); 
            });
			$("#cust-ops").click(function(){
                $("#mod_display").load("forms/customer/customer_operations.html"); 
            });
			$("#supp-ops").click(function(){
