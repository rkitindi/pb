...
<body>
	<div id="form_wrapper">
			<div id="form_section1">CONFORM OR CHANGE PERMISSION DETAILS THEN CLICK UPDATE</div>
			<form action="insert.php" method="post">
				<div id="form_section2">	
					...
					<input type="text" id="pid" name="permission_id" required placeholder="example PERM001"><br>
					<label for="pname">Permission name:</label><br>
