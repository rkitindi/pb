	...
	<div id="form_wrapper">
			...
			<form action="insert.php" method="post">
				<div id="form_section2">				
					...
					<input type="text" id="cname" name="case_name" required placeholder="Example MYCASE"><br>
					<label for="height">Case Height:</label><br>
					<input type="number" id="height" name="case_height" required placeholder="Height (cm)"><br>
					<label for="clength">Case Length:</label><br>
					<input type="number" id="clength" name="case_length" required placeholder="Length (cm)"><br>
					<label for="cwidth">Case Width:</label><br>
					<input type="number" id="cwidth" name="case_width" required placeholder="Width (cm)"><br>
