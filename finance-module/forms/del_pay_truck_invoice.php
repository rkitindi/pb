...
<body>
	<div id="form_wrapper">
			<div id="form_section1">CONFIRM TRUCK INVOICE PAYMENT DETAILS THEN CLICK DELETE BUTTON</div>
			<form action="update_role.php" method="post">
				<div id="form_section2">				
					...
					<label for="btransfer">Download Invoice:</label><br>
					<input type="text" id="btransfer" name="bank_transfer" required placeholder="Validate Invoice"><br>
