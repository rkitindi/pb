...
<body>
	<div id="form_wrapper">
			<div id="form_section1">FILL FORM BELOW WITH WATRR BILL DETAILS THEN CLICK SUBMIT</div>
			<form action="update_role.php" method="post">
				<div id="form_section2">				
					...
					<input type="text" id="btransfer" name="bank_transfer" required placeholder="Validate Actual Bill"><br>
