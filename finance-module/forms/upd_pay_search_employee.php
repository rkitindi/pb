...
<body>
	<div id="form_wrapper">
			<div id="form_section1">SELECT EMPLOYEE PAYMENT YOU WISH TO UPDATE</div>
			<form action="update_role.php" method="post">
				<div id="form_section2">
					<label for="paydate">Pay Date:</label><br>
					<input type="date" id="paydate" name="pay_date" required placeholder="Date employee was paid"><br>				
		...
		<script type="text/javascript"> 
            $("#search").click(function(){
                $("#mod_display").load("forms/upd_pay_employee.php"); 
            });
		</script>
</body>
</html>