...
<body>
	<div id="form_wrapper">
			<div id="form_section1">SEARCH A TRACK INVOICE PAYMENT YOU WISH TO DELETE</div>
			<form action="update_role.php" method="post">
				<div id="form_section2">
					<label for="paydate">Pay Date:</label><br>
					<input type="date" id="paydate" name="pay_date" required placeholder="Date Invoice payment"><br>					
