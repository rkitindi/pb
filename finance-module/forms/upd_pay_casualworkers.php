...
<body>
	<div id="form_wrapper">
			<div id="form_section1">CONFIRM OR CHANGE EMPLYEE DETAILS THEN CLICK UPDATE BUTTON</div>
			<form action="insert.php" method="post">
				<div id="form_section2">				
					...
					<input type="text" id="pos" name="pos-id" required placeholder="Select POS"><br>
