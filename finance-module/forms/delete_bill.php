...
<body>
	<div id="form_wrapper">
			<div id="form_section1"> VALIDATE BILL DETAILS BELOW THEN CLICK DELETE BUTTON</div>
			<form action="update_role.php" method="post">
				<div id="form_section2">				
					<label for="sold">Receiving Date:</label><br>
					<input type="date" id="sold" name="sold" required placeholder="Validate Date Bill was received"><br>
					...
					<input type="number" id="cheque" name="paid_cheque" required placeholder="Validate How much is it"><br>
					<label for="dispatch">Bill Status</label><br>
	                <input type="text" id="cash" name="paid_cash" required placeholder="What is this bill for"><br>
				...
				<div id="form_bottons">
					<div id="submit"><input id="search" type="submit" name="insert" value="DELETE"></div>
