	...
	<div id="form_wrapper">
			...
			<form action="update_role.php" method="post">
				<div id="form_section2">				
					...
					<input type="button" value="LEAVE TYPES" id="ltype"><br>
					<input type="button" value="DEPARTMENTS" id="dept"><br>
				</div>
		...
		<script type="text/javascript"> 
            $("#etype").click(function(){
                $("#mod_display").load("forms/setup/employment_type_ops.php"); 
            });
			$("#ptype").click(function(){
                $("#mod_display").load("forms/setup/payment_type_ops.php"); 
            });
			$("#pschedules").click(function(){
                $("#mod_display").load("forms/setup/payment_schedule_ops.php"); 
            });
			$("#ltype").click(function(){
                $("#mod_display").load("forms/setup/leave_types_ops.php"); 
            });
			$("#dept").click(function(){
                $("#mod_display").load("forms/setup/departments_ops.php"); 
            });
		</script>
</body>
</html>