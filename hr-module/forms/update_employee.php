	...
	<div id="form_wrapper">
		...
		<script type="text/javascript"> 
            $("#etype").click(function(){
                $("#mod_display").load("forms/search_employment_type.php"); 
            });
			$("#ptype").click(function(){
                $("#mod_display").load("forms/search_payment_type.php"); 
            });
			$("#pschedules").click(function(){
                $("#mod_display").load("forms/search_payment_schedule.php"); 
            });
			$("#ltype").click(function(){
                $("#mod_display").load("forms/search_leave_type.php"); 
            });
			$("#pinfo").click(function(){
                $("#mod_display").load("forms/search_employee_pinfo.php"); 
            });
			$("#sinfo").click(function(){
                $("#mod_display").load("forms/search_employee_sinfo.php"); 
            });
			$("#linfo").click(function(){
                $("#mod_display").load("forms/search_employee_linfo.php"); 
            });
			$("#binfo").click(function(){
                $("#mod_display").load("forms/search_employee_binfo.php"); 
            });
		</script>
</body>
</html>