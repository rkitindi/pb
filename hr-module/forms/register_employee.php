	...
	<div id="form_wrapper">
		...
		<script type="text/javascript"> 
            $("#etype").click(function(){
                $("#mod_display").load("forms/emplyment_type.php"); 
            });
			$("#ptype").click(function(){
                $("#mod_display").load("forms/payment_type.php"); 
            });
			$("#pschedules").click(function(){
                $("#mod_display").load("forms/payment_schedule.php"); 
            });
			$("#ltype").click(function(){
                $("#mod_display").load("forms/leave_types.php"); 
            });
			$("#pinfo").click(function(){
                $("#mod_display").load("forms/personal_info.php"); 
            });
