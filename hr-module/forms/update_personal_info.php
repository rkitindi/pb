...
<body>
	<div id="form_wrapper">
			<div id="form_section1">CONFIRM OR CHANGE EMPLOYEE PERSONAL INFORMATION</div>
			<form action="insert.php" method="post">
				<div id="form_section2">				
					...
					<input type="text" id="etype" name="employment_type" required placeholder="Select from list"><br>
				</div>
				<div id="form_bottons">
