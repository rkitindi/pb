...
<body>
	<div id="form_wrapper">
			<div id="form_section1"> FILL THIS FORM BELOW TO REGISTER A PRODUCT SALE</div>
			<form action="insert.php" method="post">
				<div id="form_section2">				
					...
					<input type="text" id="cname" name="customer_name" required placeholder="Select customer name from list"><br>
					...
					<input type="number" id="price" name="price" required placeholder="Unit Price"><br>
					<label for="paymethod">Payment Method:</label><br>
					<input type="text" id="paymethid" name="payment_method" required placeholder="Select from the list"><br><br>
					<label for="attach">Upload Check or Bank Deposit:</label><br>
					<input type="file" id="attach" name="attach_doc" required placeholder="Attach Document"><br>
					<label for="dispatch">PAID:</label><br>
            		<input type="radio" id="1" name="paid" value="1"><label for="1">YES</label>
            		<input type="radio" id="0" name="paid" value="0"><label for="0">NO</label><br>
				</div>
				<div id="form_bottons">
