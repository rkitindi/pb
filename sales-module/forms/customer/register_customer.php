...
<body>
	...
	<div id="form_wrapper">
			<div id="form_section1">FILL THIS FORM BELOW TO REGISTER CUSTOMER DETAILS</div>
			<form id="customer-form">
				<div id="form_section2">	
					<label for="cid">Customer ID:</label><br>
					<input type="text" id="cid" name="cid" required placeholder="example CUST001" style="text-transform:uppercase" onkeypress="return AvoidSpace(event)" onkeydown="limit(this);" onkeyup="limit(this);"><br>				
		...
		<script> 
            $("#submit-btn").click(function(){
               	$.post("scripts/insert_customer_details.php", $("#customer-form").serialize(), function(response) {
